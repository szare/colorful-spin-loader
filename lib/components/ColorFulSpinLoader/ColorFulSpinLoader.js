...
var ColorFulSpin = _styledComponents2.default.div(_templateObject2, function (props) {
...
var ColorFulSpinLoader = function ColorFulSpinLoader(props) {
  return _react2.default.createElement(ColorFulSpin, props);
};

ColorFulSpinLoader.propTypes = {
...
ColorFulSpinLoader.defaultProps = {
  topColor: 'blue',
  rightColor: 'red',
  bottomColor: 'green',
  leftColor: 'yellow',
...
exports.default = ColorFulSpinLoader;